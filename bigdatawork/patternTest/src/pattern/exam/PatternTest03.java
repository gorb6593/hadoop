...
public class PatternTest03 {
	public static void main(String[] args) {
		//패턴을 적용할 문자열	
		String str = "ja1111aCva--@@-@@@@- 한글 -@@@@- progra556678mmFiJng-@-vam";
		//적용할 패턴
		...
		//String patternStr =".{5}"; //5. .{n} => .은 임의의 한 문자를 의미, n은 글자 수를 의미
		//String patternStr ="[amv]{1,3}"; //6. xxxx{1,3} - -{n}는 패턴문자의 반복횟수
										   //	a,m,v가 1회,2회,3회인 문자	1이상 3이하의 자릿수
										   // a,m,v,aa,am,av,mv,aaa,aam,aav ...
		//String patternStr ="[a-z]{3,}"; //7. 영문자 소문자가 3글자 이상인 글자 추출
										  //	{3, } => 3이상
		//String patternStr ="\\W"; //8. 대문자,소문자, 숫자 뺀 모든 문자
		//String patternStr ="\\w"; //9. 대문자,소문자, 숫자만
