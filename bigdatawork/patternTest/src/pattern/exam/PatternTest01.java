...
public class PatternTest01 {
	public static void main(String[] args) {
		...
		//적용할 패턴
		//String patternStr ="java"; //1. 정확하게 일치하는지 확인
		//String patternStr ="^java"; //2. ^기호 뒤의 문자열로 시작하는지 확인
		//String patternStr ="java$"; //3. $기호 앞의 문자열로 끝나는지 확인
		//String patternStr ="^\\$";//4. 패턴에서 사용하는 기호는 일반 문자열로 인식하지 않는다.
			  					    //	 패턴에서 사용되는 기호를 문자열로 인식시키려면 \\와 함께 사용
		//String patternStr = "\\$$";//5. $문자열로 끝나는지 확인
		//String patternStr = "."; //6. .은 글자 한자리를 의미
								   //	  group메소드 때문에 한 글자씩 잘라서 리턴됨
		//String patternStr = "...."; //7. 4글자를 의미
		//String patternStr = "\\.";
		String patternStr = "\\..\\."; //8. .과 .사이의 한 글자를 찾기
