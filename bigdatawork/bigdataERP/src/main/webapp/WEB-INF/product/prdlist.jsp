<%@page import="multi.erp.product.ProductVO"%>
	...
	<div class="goodsListArea">
			...
			<ul>
				...
				<li class="typeGallery"><a href="#"
					onclick="dataViewType( 2 );return false;"> <img
						src="/bigdataERP/images/icn_gllry_2.gif" alt="갤러리 형" />
				</a></li>
				<li class="typeList"><a href="#"
					onclick="dataViewType( 1 );return false;"> <img
									src="/bigdataERP/images/icn_list_2.gif" alt="리스트 형" />
		...
		<div class="boardAreaList">
			...
			<%for(int i=0;i<size;i++){
				ProductVO product = prdlist.get(i);	
				
				%>				
			
				<li><a href="/bigdataERP/product/read.do?prd_no=<%=product.getPrd_no() %>" class="goodsLink"
					onclick="formGetSubmit( '/commerce/foffice/product/product.lime', 'r_prcode=G4135_F0002_X0004_K0040' )">
						<img src="/bigdataERP/images/product/<%=product.getImg_gen_file_nm() %>" alt="상품"
						class="photo" /><br /> <span class="proPrice1"><%=product.getPrd_nm() %></span>
					</a><br /> <span class="proPrice2"><%=product.getSell_prc_unit()%>원</span>
					...
					<ul class="bIcon">
						...
						<li><a href="#"
							onclick="basketIn( 'G4135_F0002_X0004_K0040' );return false;"><img
								src="/bigdataERP/images/bcon_cart.gif" alt="장바구니" /></a></li>
						<li><a href="#" onclick="imageZoom( '1010' );"><img
								src="/bigdataERP/images/bcon_zoom.gif" alt="확대보기" /></a></li>
