...
<title>Bootstrap Example</title>
	...
	<link type="text/css" href="/bigdataERP/common/css/master.css"
		rel="stylesheet" media="screen,print" />
	<link type="text/css" href="/bigdataERP/common/css/print.css"
		rel="stylesheet" media="print" />
	<link type="text/css" href="/bigdataERP/common/css/mall.css"
		rel="stylesheet" media="screen,print" />
	<link rel="stylesheet"
...
<body>
	...
	<div class="lyt-main">
			...
			<div class="leftWrap">
				...
				<div class="photoWrap">
					<div class="photo">
						<!-- 메인사진 -->
						<a href="#"><img
							src="/bigdataERP/images/product/<%=product.getImg_gen_file_nm() %>"
							alt="썸이미지" /></a>
					</div>
					<div class="zoomBtn">
						<!-- 확대  -->
						<a href="#" onclick="imageZoom( '918' );"><img
							src="/bigdataERP/images/btn_zoom.gif" alt="확대" /></a>
					</div>
				</div>
			</div>
			<!-- leftWrap END-->
				...
				<form name="frm" method="post" action="">
					...
					<dl class="goodsDetail" id="defaultDl">
						...
						<dd>
							...
							<div class="btns">
								<a href="#" onclick="eaUp( this, 1 ); return false;"><img
									src="/bigdataERP/resources/images/b_up.gif" alt="증가" class="al" /></a> <a href="#"
									onclick="eaUp( this, -1 ); return false;"><img
									src="/bigdataERP/resources/images/b_down.gif" alt="감소" class="al" /></a>
							</div>
						</dd>
						...
						<div class="delBtn">
							<a href="#" onclick="optionAdd( this, 0 ); return false;"> <img
								src="/bigdataERP/images/btn_icon_plus.gif" alt="추가" />
							</a>
						</div>
					...
					<ul class="btnArea mgt20">
						...
						<li><a href="#" onclick="dialogOpen('N'); return false;"><img
								src="/bigdataERP/resources/images/btnm_nowBuy.gif" alt="바로구매" /></a></li>
						<li class="marL07"><a href="#"
							onclick="basketIn('N'); return false;"><img
								src="/bigdataERP/images/btnm_cart.gif" alt="장바구니" /></a></li>
						<li class="fl_right marL07"><a href="#"
							onclick="history.back();"><img
								src="/bigdataERP/images/btnm_list.gif" alt="목록" /></a></li>
						<li class="fl_right"><a href="#"
							onclick="productWishIn( 'G4042_F0002_X0004_K0040', 'N' );return false;"><img
								src="/bigdataERP/images/btnm_wish.gif" alt="위시리스트" /></a></li>
						<li class="fl_right"><a
							href="/bigdataERP/proread.do?prdno=&action=UPDATE">업데이트</a></li>
		...
		<img src="/bigdataERP/images/product/<%=product.getImg_org_file_nm() %>"
			alt="썸이미지" />
		<div id="sky">
			<img src="/bigdataERP/images/product/<%=product.getImg_org_file_nm() %>"
		...
		<!-- =================댓글등록화면과 조회화면================================= -->
		<form method="post" 
				action="/bigdataERP/comment/write.do">
