...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#category").change(function(){
			location.href="/mvc/board/list.do?category="+encodeURI($(this).val())
		});
	});
</script>
</head>
<body>
	<% ArrayList<BoardVO> userlist = (ArrayList<BoardVO>)request.getAttribute("boardlist");
	...
	<form action="/mvc/board/search.do">
		<select name="tag">
		...
		<ul class="nav navbar-nav navbar-right">
			<li><a href="/mvc/board/insertPage.do" style="text-align: right;">글쓰기</a></li>
		</ul>
	</form>
